...
const Footer = () => {
  return (
    <footer className='flex flex-col bg-white p-8 md:py-20 md:h-[500px] justify-between '>
        ...
        <div className='flex w-full flex-col md:flex-row gap-8 md:gap-2 justify-around items-start'>
        ...
        <div className='flex w-full flex-col md:flex-row gap-8 md:gap-5  justify-around items-start'>
            <div className='flex flex-col gap-4'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center mt-6'>
            <p>© 2025 E-Africa. All rights reserved.</p>
            <div>
                <p>All Rights Reserved | <span><a href="" target="_blank" rel="noopener noreferrer" className='text-green-500 underline underline-offset-2' >Privacy Policy</a></span> |  <span> <a href="http://" target="_blank" rel="noopener noreferrer" className='text-green-500 underline underline-offset-[2px]'> Terms of Service</a></span></p>
