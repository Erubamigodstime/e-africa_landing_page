...
const BlogCardOne = ({title, description, imageUrl, className, children} :patnerCardProps) => {
  return (
   <div className='flex w-full flex-col px-2 md:flex-row items-center justify-between bg-white shadow-lg rounded-lg space-y-4 '>
           ...
           <div className='w-full  md:min-w-[200px] md:w-1/2 flex justify-center items-center transition-all duration-300 hover:scale-110'>
